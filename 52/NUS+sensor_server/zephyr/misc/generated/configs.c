...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_CMD_TX_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIPHERAL_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_ADV_MAX_ADV_SET, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MAX_CONN, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SET, 6);
