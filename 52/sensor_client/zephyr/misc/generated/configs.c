...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_CMD_TX_COUNT, 30);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIPHERAL_COUNT, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_ADV_MAX_ADV_SET, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MAX_CONN, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_FRAG_COUNT, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ID_MAX, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SET, 9);
